...
{  
    ...
    isLost = true;
    buttons[rows/2][(columns/2)-4].setLabel("u");
    buttons[rows/2][(columns/2)-3].setLabel("");
    buttons[rows/2][(columns/2-2)].setLabel("l");
    buttons[rows/2][(columns/2-1)].setLabel("o");
    buttons[rows/2][(columns/2)].setLabel("s");
    buttons[rows/2][(columns/2+1)].setLabel("t");
    buttons[rows/2][(columns/2+2)].setLabel("");
    buttons[rows/2][(columns/2+3)].setLabel("b");
    buttons[rows/2][(columns/2+4)].setLabel("r");
    buttons[rows/2][(columns/2+5)].setLabel("o");
}
